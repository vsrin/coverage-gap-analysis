  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      ...
      <div className="mt-6 text-center max-w-xl">
        <h3 className="font-medium text-gray-700 mb-2">Try uploading your files directly:</h3>
...
// FileUploadOnly component for error cases
const FileUploadOnlyScreen = () => {
  const [uploadedFiles, setUploadedFiles] = useState([]);
      ...
      <div className="flex-grow p-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-medium mb-4">Upload Your Insurance Documents</h2>
            <p className="text-gray-600 mb-6">
              Upload your policy documents to analyze coverage gaps and identify improvement opportunities.
            </p>
            ...
            {uploadedFiles.length > 0 && (
              <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
                ...
                <p className="mt-2 text-sm text-green-600">
                  Your documents are being processed. Analysis will be available shortly.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="flex-grow p-6">
          {error && !showUploadOnly ? (
            <div className="mb-6">
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-yellow-700">
                      {error} Don't worry, you can still proceed by uploading your files directly.
                    </p>
                  </div>
                </div>
              </div>
              <button 
                className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700"
                onClick={() => setShowUploadOnly(true)}
              >
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <PolicyUpload onFilesProcessed={(files) => setUploadedFiles(files)} />
              </div>
            </div>
          )}
        </div>
